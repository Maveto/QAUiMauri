...
public class BasicCreateProjectTest {
    ...
    public void loginTodoLy() throws InterruptedException {
        ...
        //Buscar el proyecto
        driver.findElement(By.xpath("//li[last()]//td[contains(.,'newProject') and @class='ProjItemContent']")).click();
        //Abrir menu
        driver.findElement(By.xpath("//div[@class='ProjItemMenu' and @style=\"display: block;\"]//img[@src='/Images/dropdown.png']")).click();
        //Presionar Delete
        driver.findElement(By.xpath("//a[@id='ProjShareMenuDel']")).click();
